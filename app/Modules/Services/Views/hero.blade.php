@desktop
<section class=" bg-crystawall-dark lg:bg-[url('/public/assest/v2/img/hero_desktop/1-9.webp')] bg-bottom bg-cover text-white h-[40vh] md:h-[93vh] -z-10 shadow-[0px_-5px_10px_5px] shadow-crystawall-dark">
    <div class="py-0 px-4 mx-auto max-w-screen-xl md:max-w-screen-lg 2xl:max-w-screen-xl text-left h-2/3 content-bottom">
        <div class="flex flex-row items-stretch h-[80%] ">
            <div class="self-center md:self-end pb-10">
                <h1 class="text-base font-light ">Our Services: We drive strategy, design brands, tell stories and more</h1>
                <h2 data-aos="fade-right" data-aos-duration="2000" class="mb-4 text-5xl font-light tracking-tight leading-none  md:text-5xl 2xl:text-8xl xl:text-6xl  my-8">
                    From Concept to <span class="gradient-text">Design</span>
                </h2>
            </div>
            <div class="md:w-[500px] hidden md:grid grid-cols-1 gap-4 content-between">
            </div>
        </div>
        {{-- <div class="hidden lg:hidden 2xl:block absolute bottom-20 left-0 w-full px-0">
            <hr class="bg-crystawall-outline mb-2 ">
...
@mobile
<section class=" text-white  bg-[url('/public/assest/v2/img/hero_mobile/1-9.webp')] bg-center bg-cover h-[70vh] shadow-[0px_-5px_10px_5px] shadow-crystawall-dark">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 lg:px-12 h-full content-center">
        <h1 class="my-auto text-base md:text-base">
            Our Services: We drive strategy, design brands, tell stories and more
        </h1>
